            ...
            <nav>
                <ul className='flex items-center gap-4 poppins-medium'>
                    ...
                    <li className="relative group">
                        <NavLink to="/about" className={({ isActive }) =>` text-base py-3 px-2 hover:text-[#031359] ${isActive ? 'text-[#1f276e]' : 'hover:text-[#031359] text-[#1f276e]'}`}>About</NavLink>
                    </li>
                    <li 
                    className="relative"
                    ...
                    <li className="relative group"><NavLink to="/capabilities" className={({ isActive }) =>` text-base py-3 px-2 hover:text-[#031359] ${isActive ? 'text-[#1f276e]' : 'hover:text-[#031359] text-[#1f276e]'}`}>Capabilities</NavLink></li>
                    <li className="relative group"><NavLink to="/coverage" className={({ isActive }) =>` text-base py-3 px-2 hover:text-[#031359] ${isActive ? 'text-[#1f276e]' : 'hover:text-[#031359] text-[#1f276e]'}`}>Coverage</NavLink></li>
                    ...
                    <li><NavLink className="bg-[#1f276e] px-5 py-3 rounded-[50px] text-white" >Become a Partner</NavLink></li>
                </ul>
            </nav>
        </div>
    </section>
