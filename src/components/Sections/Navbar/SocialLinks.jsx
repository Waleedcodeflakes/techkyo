...
const SocialLinks = () => {
  return (
    <div className='w-full bg-white'>
        <div className='w-[92%] sm:w-[90%] m-auto flex items-center justify-end gap-4 mt-3'>
            ...
            <a href="https://www.youtube.com/techkyo" target='_blank'><Youtube className='w-5 h-5 text-[#01135c]'/></a>
