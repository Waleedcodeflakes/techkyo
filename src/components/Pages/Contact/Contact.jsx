        ...
        <section className='my-20 text-center w-[92%] sm:w-[80%] m-auto'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 mt-8'>
                <div style={{boxShadow: '0 10px 35px rgba(38, 42, 76, 0.1)'}} className='rounded-[14px] p-5 border border-[#e8e8e8] flex flex-col gap-5 justify-center'>
                    ...
                    <h3 className='poppins-semibold text-[20px] text-[#1f276e]'>Japan Office</h3>
                    <p className='poppins-medium text-[15px] text-[#696969]'>450 Bath Road, Longford, Heathrow London, UB7 0EB, Japan</p>
                </div>
                <div style={{boxShadow: '0 10px 35px rgba(38, 42, 76, 0.1)'}} className='rounded-[14px] p-5 border border-[#e8e8e8] flex flex-col gap-5 justify-center'>
                    <MapPinCheck className='w-6 h-6 self-center text-[#1f276e]' />
                    <h3 className='poppins-semibold text-[20px] text-[#1f276e]'>Pakistan Office</h3>
                    <p className='poppins-medium text-[15px] text-[#696969]'>Jadoon Plaza Phase 2, Abbottabad Pakistan</p>
                </div>
                ...
                <div style={{boxShadow: '0 10px 35px rgba(38, 42, 76, 0.1)'}} className='rounded-[14px] p-5 border border-[#e8e8e8] flex flex-col gap-5 justify-center items-center'>
                    ...
                    <p className='poppins-medium text-[15px] text-[#696969]'>sales@htechsupports.com</p>
                    <p className='poppins-medium text-[15px] text-[#696969]'>contact@htechsupports.com</p>
                </div>
            </div>
