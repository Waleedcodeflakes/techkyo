  ...
  return (
    <div>
        ...
        <section className='my-20 bg-[#f0f1f5]'>
            <div className='flex flex-col gap-6 h-[350px] w-[92%] sm:w-[80%] m-auto items-center text-center justify-center'>
        ...
        <section className='my-20'>
            <div className='block sm:flex gap-6 h-[350px] w-[92%] sm:w-[80%] m-auto items-center text-left justify-between'>
                ...
                <div className='w-full sm:w-[50%] py-14 sm:py-0 flex items-center justify-end'>
        ...
        {/* why techkyo */}
        <section className='my-20'>
            <section className='w-[92%] sm:w-[80%] m-auto py-24'>
            <h2 className='poppins-semibold text-[40px] text-[#1f276e] text-center mt-30 sm:mt-0'>WHY Techkyo SUPPORT</h2>
